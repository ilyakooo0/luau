...
a={}
;
local lim = _soft and 200 or 2e3
for i = 1, lim
do
a[i]=i
end
...
(f,e,t,x,y)
local pos1,pos2 = 
local a = setmetatable({},{["__index"] = (_,k)
pos1=k
end,["__newindex"] = (_,k)
pos2=k
;
...
AA={"álo","first :-)","alo","then this one","45","and a new"}
table.sort(AA)
check(AA)
table.sort(AA,(x,y)
