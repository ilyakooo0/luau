...
assert(not pcall(debug.getinfo,0,"\u{3e}"))
...
assert(b.name == nil and b.what == "\u{4c}\u{75}\u{61}" and b.linedefined == testline and b.lastlinedefined == b.linedefined + 10 and b.func == test and not string.find(b.short_src,"\u{25}\u{5b}"))
...
dostring(a .. string.format("\u{3b}\u{20}\u{25}\u{73}\u{a}\u{3d}\u{31}",string.rep("\u{70}",400)))
...
dostring(a .. string.format("\u{3b}\u{20}\u{25}\u{73}\u{3d}\u{31}",string.rep("\u{70}",400)))
assert(string.find(debug.getinfo(f).short_src,"\u{5e}\u{25}\u{5b}\u{73}\u{74}\u{72}\u{69}\u{6e}\u{67}\u{20}\u{5b}\u{5e}\u{a}\u{5d}\u{2a}\u{25}\u{2e}\u{25}\u{2e}\u{25}\u{2e}\u{22}\u{25}\u{5d}\u{24}"))
dostring("\u{a}" .. a)
...
dostring(a,"\u{40}" .. string.rep("\u{70}",1000) .. "\u{74}")
...
assert(debug.getinfo(f).short_src == "\u{78}\u{75}\u{78}\u{75}")
dostring(a,string.format("\u{3d}\u{25}\u{73}",string.rep("\u{78}",500)))
...
assert(g(f) == "\u{61}")
until 1
test("\u{69}\u{66}\u{a}\u{6d}\u{61}\u{74}\u{68}\u{2e}\u{73}\u{69}\u{6e}\u{28}\u{31}\u{29}\u{a}\u{74}\u{68}\u{65}\u{6e}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{31}\u{a}\u{65}\u{6c}\u{73}\u{65}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{32}\u{a}\u{65}\u{6e}\u{64}\u{a}",{2,3,4,7})
test("\u{6c}\u{6f}\u{63}\u{61}\u{6c}\u{20}\u{66}\u{75}\u{6e}\u{63}\u{74}\u{69}\u{6f}\u{6e}\u{20}\u{66}\u{6f}\u{6f}\u{28}\u{29}\u{a}\u{65}\u{6e}\u{64}\u{a}\u{66}\u{6f}\u{6f}\u{28}\u{29}\u{a}\u{41}\u{20}\u{3d}\u{20}\u{31}\u{a}\u{41}\u{20}\u{3d}\u{20}\u{32}\u{a}\u{41}\u{20}\u{3d}\u{20}\u{33}\u{a}",{2,3,2,4,5,6})
_G.A=nil
test("\u{2d}\u{2d}\u{a}\u{69}\u{66}\u{20}\u{6e}\u{69}\u{6c}\u{20}\u{74}\u{68}\u{65}\u{6e}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{31}\u{a}\u{65}\u{6c}\u{73}\u{65}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{32}\u{a}\u{65}\u{6e}\u{64}\u{a}",{2,5,6})
test("\u{61}\u{3d}\u{31}\u{a}\u{72}\u{65}\u{70}\u{65}\u{61}\u{74}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{61}\u{2b}\u{31}\u{a}\u{75}\u{6e}\u{74}\u{69}\u{6c}\u{20}\u{61}\u{3d}\u{3d}\u{33}\u{a}",{1,3,4,3,4})
test("\u{20}\u{64}\u{6f}\u{a}\u{20}\u{20}\u{72}\u{65}\u{74}\u{75}\u{72}\u{6e}\u{a}\u{65}\u{6e}\u{64}\u{a}",{2})
test("\u{6c}\u{6f}\u{63}\u{61}\u{6c}\u{20}\u{61}\u{a}\u{61}\u{3d}\u{31}\u{a}\u{77}\u{68}\u{69}\u{6c}\u{65}\u{20}\u{61}\u{3c}\u{3d}\u{33}\u{20}\u{64}\u{6f}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{61}\u{2b}\u{31}\u{a}\u{65}\u{6e}\u{64}\u{a}",{1,2,3,4,3,4,3,4,3,5})
test("\u{77}\u{68}\u{69}\u{6c}\u{65}\u{20}\u{6d}\u{61}\u{74}\u{68}\u{2e}\u{73}\u{69}\u{6e}\u{28}\u{31}\u{29}\u{20}\u{64}\u{6f}\u{a}\u{20}\u{20}\u{69}\u{66}\u{20}\u{6d}\u{61}\u{74}\u{68}\u{2e}\u{73}\u{69}\u{6e}\u{28}\u{31}\u{29}\u{a}\u{20}\u{20}\u{74}\u{68}\u{65}\u{6e}\u{20}\u{62}\u{72}\u{65}\u{61}\u{6b}\u{a}\u{20}\u{20}\u{65}\u{6e}\u{64}\u{a}\u{65}\u{6e}\u{64}\u{a}\u{61}\u{3d}\u{31}",{1,2,3,6})
test("\u{66}\u{6f}\u{72}\u{20}\u{69}\u{3d}\u{31}\u{2c}\u{33}\u{20}\u{64}\u{6f}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{69}\u{a}\u{65}\u{6e}\u{64}\u{a}",{1,2,1,2,1,2,1,3})
test("\u{66}\u{6f}\u{72}\u{20}\u{69}\u{2c}\u{76}\u{20}\u{69}\u{6e}\u{20}\u{70}\u{61}\u{69}\u{72}\u{73}\u{7b}\u{27}\u{61}\u{27}\u{2c}\u{27}\u{62}\u{27}\u{7d}\u{20}\u{64}\u{6f}\u{a}\u{20}\u{20}\u{61}\u{3d}\u{74}\u{6f}\u{73}\u{74}\u{72}\u{69}\u{6e}\u{67}\u{28}\u{69}\u{29}\u{20}\u{2e}\u{2e}\u{20}\u{76}\u{a}\u{65}\u{6e}\u{64}\u{a}",{1,2,1,2,1,3})
test("\u{66}\u{6f}\u{72}\u{20}\u{69}\u{3d}\u{31}\u{2c}\u{34}\u{20}\u{64}\u{6f}\u{20}\u{61}\u{3d}\u{31}\u{20}\u{65}\u{6e}\u{64}",{1,1,1,1})
_G.a=nil
do
...
do
checkactivelines(load(string.format("\u{25}\u{73}\u{20}\u{72}\u{65}\u{74}\u{75}\u{72}\u{6e}\u{20}\u{31}",string.rep("\u{a}",n))),{n + 1})
end
end
print("\u{2b}")
...
assert(debug.getlocal(foo,1) == "\u{61}")
assert(debug.getlocal(foo,2) == "\u{62}")
assert(not debug.getlocal(foo,3))
assert(debug.getlocal(co,foo,1) == "\u{61}")
assert(debug.getlocal(co,foo,2) == "\u{62}")
...
if t.n > 0 then
(function (x)
assert(debug.setlocal(2,- 1,x) == "\u{28}\u{76}\u{61}\u{72}\u{61}\u{72}\u{67}\u{29}")
assert(debug.setlocal(2,- t.n,x) == "\u{28}\u{76}\u{61}\u{72}\u{61}\u{72}\u{67}\u{29}")
end)(430)
assert(... == 430)
end
end
...
local function f
()
assert(debug.getinfo(1).namewhat == "\u{68}\u{6f}\u{6f}\u{6b}")
...
assert(m == "\u{63}\u{72}\u{6c}" and c == 0)
...
local f = debug.getinfo(2,"\u{66}").func
a[f]=1
else
...
assert(x == a and y == b)
assert(debug.setlocal(2,3,"\u{70}\u{65}\u{72}\u{61}") == "\u{41}\u{41}" .. "\u{41}\u{41}")
assert(debug.setlocal(2,4,"\u{6d}\u{61}\u{6e}\u{67}\u{61}") == "\u{42}")
x=debug.getinfo(2)
assert(x.func == g and x.what == "\u{4c}\u{75}\u{61}" and x.name == "\u{67}" and x.nups == 2 and string.find(x.source,"\u{5e}\u{40}\u{2e}\u{2a}\u{64}\u{62}\u{25}\u{2e}\u{6c}\u{75}\u{61}\u{24}"))
glob=glob + 1
assert(debug.getinfo(1,"\u{6c}").currentline == L + 1)
assert(debug.getinfo(1,"\u{6c}").currentline == L + 2)
end
function foo()
glob=glob + 1
assert(debug.getinfo(1,"\u{6c}").currentline == L + 1)
...
assert(debug.getinfo(1,"\u{6c}").currentline == L + 11)
function g(...)
local arg = {...}
do
local a,b,c
...
assert(x == "\u{42}" and y == 13)
end
end
g()
assert(a[f] and a[g] and a[assert] and a[debug.getlocal] and not a[print])
local n,v = debug.getlocal(0,1)
assert(v == 0 and n == "\u{28}\u{43}\u{20}\u{74}\u{65}\u{6d}\u{70}\u{6f}\u{72}\u{61}\u{72}\u{79}\u{29}")
local n,v = debug.getlocal(0,2)
assert(v == 2 and n == "\u{28}\u{43}\u{20}\u{74}\u{65}\u{6d}\u{70}\u{6f}\u{72}\u{61}\u{72}\u{79}\u{29}")
...
debug.sethook(function (e,l)
assert(debug.getinfo(2,"\u{6c}").currentline == l)
local f,m,c = debug.gethook()
assert(e == "\u{6c}\u{69}\u{6e}\u{65}")
assert(m == "\u{6c}" and c == 0)
debug.sethook(nil)
assert(not X)
X=collectlocals(2)
end,"\u{6c}")
...
local function aux
()
if debug.getinfo(2).name == "\u{66}\u{6f}\u{6f}" then
X=true
local tab = {["\u{61}"] = 100,["\u{62}"] = 200,["\u{63}"] = 10,["\u{64}"] = 20}
...
local ar = debug.getinfo(2,"\u{72}\u{75}\u{53}")
local t = {}
...
assert(not debug.setupvalue(foo1,3,"\u{78}\u{75}\u{78}\u{75}"))
local t = getupvalues(foo1)
assert(t.a == nil and t.b == 2 and t.c == 3)
t=getupvalues(foo2)
assert(t.a == 1 and t.b == 2 and t.c == 3)
assert(debug.setupvalue(foo1,1,"\u{78}\u{75}\u{78}\u{75}") == "\u{62}")
assert(({debug.getupvalue(foo2,3)})[2] == "\u{78}\u{75}\u{78}\u{75}")
assert(debug.getupvalue(string.gmatch("\u{78}","\u{78}"),1) == "")
local a = 0
debug.sethook(function (e)
a=a + 1
end,"",1)
...
(x)
if x then
assert(debug.getinfo(1,"\u{53}").what == "\u{4c}\u{75}\u{61}")
assert(debug.getinfo(1,"\u{74}").istailcall == true)
local tail = debug.getinfo(2)
assert(tail.func == g1 and tail.istailcall == true)
assert(debug.getinfo(3,"\u{53}").what == "\u{6d}\u{61}\u{69}\u{6e}")
print("\u{2b}")
end
end
function g(x)
...
b=b + 1
assert(debug.getinfo(2,"\u{74}").istailcall == true)
else
assert(debug.getinfo(2,"\u{74}").istailcall == false)
end
end,"\u{63}")
h(false)
debug.sethook()
...
(x)
if x == 0 then
assert(debug.getinfo(2).what == "\u{6d}\u{61}\u{69}\u{6e}")
...
a=a + 1
;
assert(debug.getlocal(2,1) == "\u{28}\u{74}\u{65}\u{6d}\u{70}\u{6f}\u{72}\u{61}\u{72}\u{79}\u{29}")
elseif l == 4 then
a=a + 1
;
assert(debug.getlocal(2,1) == "\u{41}")
end
end,"\u{6c}")
co()
debug.sethook()
...
assert(string.find(debug.traceback("\u{68}\u{69}",4),"\u{5e}\u{68}\u{69}\u{a}"))
...
assert(string.find(debug.traceback("\u{68}\u{69}",0),"\u{27}\u{64}\u{65}\u{62}\u{75}\u{67}\u{2e}\u{74}\u{72}\u{61}\u{63}\u{65}\u{62}\u{61}\u{63}\u{6b}\u{27}"))
...
t=debug.getinfo(1)
assert(t.isvararg == true and t.nparams == 0 and t.nups == 1 and debug.getupvalue(t.func,1) == "\u{5f}\u{45}\u{4e}\u{56}")
...
checktraceback(co,{"\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}","\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}","\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}","\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}"},1)
checktraceback(co,{"\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}","\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}","\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}"},2)
checktraceback(co,{"\u{64}\u{62}\u{2e}\u{6c}\u{75}\u{61}"},4)
checktraceback(co,{},40)
co=coroutine.create(function (x)
local a = 1
coroutine.yield(debug.getinfo(1,"\u{6c}"))
coroutine.yield(debug.getinfo(1,"\u{6c}").currentline)
return a
end)
local tr = {}
...
local x = debug.getinfo(co,1,"\u{6c}\u{66}\u{4c}\u{53}")
...
assert(a == "\u{78}" and b == 10)
a,b=debug.getlocal(co,1,2)
assert(a == "\u{61}" and b == 1)
debug.setlocal(co,1,2,"\u{68}\u{69}")
...
assert(debug.setlocal(co,1,1,30) == "\u{78}")
...
checktraceback(co,t)
a,b=coroutine.resume(co)
table.insert(t,2,"\u{27}\u{66}\u{27}")
end
t[1]="\u{27}\u{65}\u{72}\u{72}\u{6f}\u{72}\u{27}"
checktraceback(co,t)
local function g
(x)
coroutine.yield(x)
...
assert(a[3] == "\u{69}\u{6e}\u{64}\u{65}\u{78}" and a ^ 3 == "\u{70}\u{6f}\u{77}" and a .. a == "\u{63}\u{6f}\u{6e}\u{63}\u{61}\u{74}")
assert(a / 3 == "\u{64}\u{69}\u{76}" and 3 % a == "\u{6d}\u{6f}\u{64}")
assert(a + 3 == "\u{61}\u{64}\u{64}" and 3 - a == "\u{73}\u{75}\u{62}" and a * 3 == "\u{6d}\u{75}\u{6c}" and - a == "\u{75}\u{6e}\u{6d}" and # a == "\u{6c}\u{65}\u{6e}" and a & 3 == "\u{62}\u{61}\u{6e}\u{64}")
assert(a + 30000 == "\u{61}\u{64}\u{64}" and a - 3.0 == "\u{73}\u{75}\u{62}" and a * 3.0 == "\u{6d}\u{75}\u{6c}" and - a == "\u{75}\u{6e}\u{6d}" and # a == "\u{6c}\u{65}\u{6e}" and a & 3 == "\u{62}\u{61}\u{6e}\u{64}")
assert(a | 3 == "\u{62}\u{6f}\u{72}" and 3 ~ a == "\u{62}\u{78}\u{6f}\u{72}" and a << 3 == "\u{73}\u{68}\u{6c}" and a >> 1 == "\u{73}\u{68}\u{72}")
assert(a == b and a.op == "\u{65}\u{71}")
assert(a >= b and a.op == "\u{6c}\u{65}")
assert("\u{78}" >= a and a.op == "\u{6c}\u{65}")
assert(a > b and a.op == "\u{6c}\u{74}")
assert(a > 10 and a.op == "\u{6c}\u{74}")
assert(~ a == "\u{62}\u{6e}\u{6f}\u{74}")
do
local function f
()
assert(debug.getinfo(1).name == "\u{66}\u{6f}\u{72}\u{20}\u{69}\u{74}\u{65}\u{72}\u{61}\u{74}\u{6f}\u{72}")
end
for i in f
do
...
(s)
return select(2,string.gsub(s,"\u{a}",""))
end
local function deep
(lvl,n)
if lvl == 0 then
...
local name = string.rep("\u{78}",1000)
