...
assert(math.type(0) == "\u{69}\u{6e}\u{74}\u{65}\u{67}\u{65}\u{72}" and math.type(0.0) == "\u{66}\u{6c}\u{6f}\u{61}\u{74}" and not math.type("\u{31}\u{30}"))
...
assert(a + b == 5 and - b == - 3 and b + "\u{32}" == 5 and "\u{31}\u{30}" - c == 0)
...
checkcompt(msgf2i,("\u{72}\u{65}\u{74}\u{75}\u{72}\u{6e}\u{20}\u{32}\u{2e}\u{30}\u{5e}\u{25}\u{64}\u{20}\u{26}\u{20}\u{31}"):format(intbits - 1))
...
checkcompt(msgf2i,("\u{72}\u{65}\u{74}\u{75}\u{72}\u{6e}\u{20}\u{31}\u{20}\u{7c}\u{20}\u{32}\u{2e}\u{30}\u{5e}\u{25}\u{64}"):format(intbits - 1))
...
assert("\u{32}" + 1 == 3)
assert("\u{32}\u{20}" + 1 == 3)
assert("\u{20}\u{2d}\u{32}\u{20}" + 1 == - 1)
assert("\u{20}\u{2d}\u{30}\u{78}\u{61}\u{20}" + 1 == - 9)
do
...
assert(eqT(tonumber("\u{31}" .. string.rep("\u{30}",30)),1e30))
assert(eqT(tonumber("\u{2d}\u{31}" .. string.rep("\u{30}",30)),- 1e30))
assert(eqT(tonumber("\u{30}\u{78}\u{31}" .. string.rep("\u{30}",30)),0))
...
assert(tonumber("\u{30}") == 0)
assert(not tonumber(""))
assert(not tonumber("\u{20}\u{20}"))
assert(not tonumber("\u{2d}"))
assert(not tonumber("\u{20}\u{20}\u{2d}\u{30}\u{78}\u{20}"))
assert(not tonumber({}))
assert(tonumber("\u{2b}\u{30}\u{2e}\u{30}\u{31}") == 1 / 100 and tonumber("\u{2b}\u{2e}\u{30}\u{31}") == 0.01 and tonumber("\u{2e}\u{30}\u{31}") == 0.01 and tonumber("\u{2d}\u{31}\u{2e}") == - 1 and tonumber("\u{2b}\u{31}\u{2e}") == 1)
...
assert(tonumber("\u{2d}\u{30}\u{31}\u{32}") == - 10 - 2)
assert(tonumber("\u{2d}\u{31}\u{2e}\u{32}\u{65}\u{32}") == - - - 120)
assert(tonumber("\u{30}\u{78}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}") == (1 << (4 * 12)) - 1)
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{66}",(intbits // 4))) == - 1)
assert(tonumber("\u{2d}\u{30}\u{78}" .. string.rep("\u{66}",(intbits // 4))) == 1)
assert(tonumber("\u{20}\u{20}\u{30}\u{30}\u{31}\u{30}\u{31}\u{30}\u{20}\u{20}",2) == 10)
assert(tonumber("\u{20}\u{20}\u{30}\u{30}\u{31}\u{30}\u{31}\u{30}\u{20}\u{20}",10) == 1010)
assert(tonumber("\u{20}\u{20}\u{2d}\u{31}\u{30}\u{31}\u{30}\u{20}\u{20}",2) == - 10)
assert(tonumber("\u{31}\u{30}",36) == 36)
assert(tonumber("\u{20}\u{20}\u{2d}\u{31}\u{30}\u{20}\u{20}",36) == - 36)
assert(tonumber("\u{20}\u{20}\u{2b}\u{31}\u{5a}\u{20}\u{20}",36) == 36 + 35)
assert(tonumber("\u{20}\u{20}\u{2d}\u{31}\u{7a}\u{20}\u{20}",36) == - 36 + - 35)
assert(tonumber("\u{2d}\u{66}\u{46}\u{66}\u{61}",16) == - (10 + (16 * (15 + (16 * (15 + (16 * 15)))))))
assert(tonumber(string.rep("\u{31}",(intbits - 2)),2) + 1 == 2 ^ (intbits - 2))
assert(tonumber("\u{66}\u{66}\u{66}\u{66}\u{46}\u{46}\u{46}\u{46}",16) + 1 == (1 << 32))
assert(tonumber("\u{30}\u{66}\u{66}\u{66}\u{66}\u{46}\u{46}\u{46}\u{46}",16) + 1 == (1 << 32))
assert(tonumber("\u{2d}\u{30}\u{66}\u{66}\u{66}\u{66}\u{66}\u{66}\u{46}\u{46}\u{46}\u{46}",16) - 1 == - (1 << 40))
for i = 2, 36
do
local i2 = i * i
...
if not _soft then
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{66}",13) .. "\u{2e}\u{30}") == 2.0 ^ (4 * 13) - 1)
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{66}",150) .. "\u{2e}\u{30}") == 2.0 ^ (4 * 150) - 1)
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{66}",300) .. "\u{2e}\u{30}") == 2.0 ^ (4 * 300) - 1)
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{66}",500) .. "\u{2e}\u{30}") == 2.0 ^ (4 * 500) - 1)
assert(tonumber("\u{30}\u{78}\u{33}\u{2e}" .. string.rep("\u{30}",1000)) == 3)
assert(tonumber("\u{30}\u{78}" .. string.rep("\u{30}",1000) .. "\u{61}") == 10)
assert(tonumber("\u{30}\u{78}\u{30}\u{2e}" .. string.rep("\u{30}",13) .. "\u{31}") == 2.0 ^ (- 4 * 14))
assert(tonumber("\u{30}\u{78}\u{30}\u{2e}" .. string.rep("\u{30}",150) .. "\u{31}") == 2.0 ^ (- 4 * 151))
assert(tonumber("\u{30}\u{78}\u{30}\u{2e}" .. string.rep("\u{30}",300) .. "\u{31}") == 2.0 ^ (- 4 * 301))
assert(tonumber("\u{30}\u{78}\u{30}\u{2e}" .. string.rep("\u{30}",500) .. "\u{31}") == 2.0 ^ (- 4 * 501))
assert(tonumber("\u{30}\u{78}\u{65}\u{30}\u{33}" .. string.rep("\u{30}",1000) .. "\u{70}\u{2d}\u{34}\u{30}\u{30}\u{30}") == 3587.0)
assert(tonumber("\u{30}\u{78}\u{2e}" .. string.rep("\u{30}",1000) .. "\u{37}\u{34}\u{70}\u{34}\u{30}\u{30}\u{34}") == 7.25)
end
local function f
(...)
if select("\u{23}",...) == 1 then
return (...)
else
return "\u{2a}\u{2a}\u{2a}"
end
end
assert(not f(tonumber("\u{66}\u{46}\u{66}\u{61}",15)))
assert(not f(tonumber("\u{30}\u{39}\u{39}",8)))
assert(not f(tonumber("\u{31}\u{0}",2)))
assert(not f(tonumber("",8)))
assert(not f(tonumber("\u{20}\u{20}",9)))
assert(not f(tonumber("\u{20}\u{20}",9)))
assert(not f(tonumber("\u{30}\u{78}\u{66}",10)))
...
assert(not f(tonumber("\u{31}\u{20}\u{20}\u{61}",2)))
...
assert(tonumber("\u{2b}\u{30}\u{78}\u{32}") == 2)
assert(tonumber("\u{2d}\u{30}\u{78}\u{61}\u{41}") == - 170)
assert(tonumber("\u{2d}\u{30}\u{78}\u{66}\u{66}\u{46}\u{46}\u{46}\u{66}\u{66}\u{66}") == - (1 << 32) + 1)
assert(0.0 == 0 and 14 + 1 == 15 and 14 - 1 == 13)
assert(tonumber("\u{20}\u{20}\u{30}\u{78}\u{32}\u{2e}\u{35}\u{20}\u{20}") == 37 / 16)
assert(tonumber("\u{20}\u{20}\u{2d}\u{30}\u{78}\u{32}\u{2e}\u{35}\u{20}\u{20}") == - 37 / 16)
assert(tonumber("\u{20}\u{20}\u{2b}\u{30}\u{78}\u{30}\u{2e}\u{35}\u{31}\u{70}\u{2b}\u{38}\u{20}\u{20}") == 81)
assert(0.9999999997671694 == 1 - "\u{30}\u{78}\u{2e}\u{30}\u{30}\u{30}\u{30}\u{30}\u{30}\u{30}\u{31}")
assert("\u{30}\u{78}\u{41}\u{2e}\u{61}" + 0 == 10 + 10 / 16)
assert(170.0 == 170)
assert(1.0 == 1)
...
assert(tonumber("\u{2b}\u{31}\u{2e}\u{32}\u{33}\u{45}\u{31}\u{38}") == 1.23 * 10.0 ^ 18)
...
assert(math.ceil(- math.huge) == - math.huge)
assert(not math.tointeger(- math.huge))
assert(math.tointeger("\u{33}\u{34}\u{2e}\u{30}") == 34)
...
checkerror("\u{7a}\u{65}\u{72}\u{6f}",math.fmod,3,0)
do
...
assert(not pcall(rawset,a,NaN,1))
assert(a[NaN] == undef)
local a1,a2,a3,a4,a5 = 0,0,"\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}",0,"\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}\u{0}"
